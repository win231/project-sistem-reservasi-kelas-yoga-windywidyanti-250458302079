                    ...
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        ...
                        <div class="avatar avatar-xl mb-3">
                            <div class="avatar-content" style="background-color: #435ebe; color: white; font-size: 2rem; width: 120px; height: 120px; display: flex; align-items: center; justify-content: center; border-radius: 50%;">
                                <?php echo e($this->getInitials()); ?>

                            </div>
                        </div>

                        <h3 class="mt-3"><?php echo e($name); ?></h3>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <?php if(session()->has('password_message')): ?>
                        <div class="alert alert-<?php echo e(session('password-alert-type')); ?> alert-dismissible fade show" role="alert">
                            <?php echo e(session('password_message')); ?>
...
<?php /**PATH D:\bismillah-PJfixyaa\bismillah-PJfix\resources\views/livewire/member/profil.blade.php ENDPATH**/ ?>