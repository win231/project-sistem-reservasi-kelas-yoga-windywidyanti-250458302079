                ...
                <div class="col-12 mb-4">
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <div class="mb-2">
                            ...
                            <small>
                                <i class="bi bi-calendar-event me-1"></i>{{ $class['start_time']->translatedFormat('l, d F Y - H:i') }} WIB<br>
                                <i class="bi bi-person me-1"></i>Instruktur: {{ $class['instructor'] }}<br>
                                <i class="bi bi-geo-alt me-1"></i>Lokasi: {{ $class['location'] }}
                            </small>
                        </div>
                        @if(!$loop->last)
                        <hr class="my-2">
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $bookingTerkonfirmasi }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-4 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $estimasiWaktu > 0 ? $estimasiWaktu . ' hari' : '-' }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-primary">
                                    <i class="bi bi-bookmark-check me-1"></i>{{ count($calendarEvents) }} Booking
                                </span>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventClick: function(info) {
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('member.booking') }}" class="btn btn-primary">
