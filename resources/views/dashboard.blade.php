...
<head>
    ...
    <title>Dashboard Member- Gymora Studio</title>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <a href="jadwal.html" class='sidebar-link'>
                                <i class="bi bi-calendar-heart"></i> <span>Jadwal Kelas</span>
                            </a>
                        </li>
